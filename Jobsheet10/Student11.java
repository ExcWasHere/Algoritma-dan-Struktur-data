...
public class Student11 {
    ...
    public static void gradeAssignment(Scanner scanner, StudentAssignmentStack stack) {
        ...
        System.out.println("Grading assignment for: " + student.getName());
        System.out.print("Enter grade: ");
        int grade = scanner.nextInt();
        scanner.nextLine();
        student.setGrade(grade);
        System.out.println("Assignment for " + student.getName() + " has been graded with " + grade);
    }
    ...
    public static void viewTopAssignment(StudentAssignmentStack stack) {
        ...
        System.out.println("Grade: " + (student.getGrade() == 0 ? "Not graded yet" : student.getGrade()));
